...
namespace NavigationModule.Journeys.Services.Foundations.Journeys
{
    public partial class JourneyService : IJourneyService
    {
        ...
        public ValueTask<(List<Journey> locations, long count)> RetrieveFilteredJourneysAsync(
        ...
        public ValueTask<Journey> RetrieveJourneyByFilterAsync(
            Expression<Func<Journey, bool>> searchCondition) =>
            TryCatch(async () =>
            {
                return await this.storageBroker.SelectJourneyByFilterAsync(searchCondition);
            });
